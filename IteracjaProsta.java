...
public class IteracjaProsta {
    ...
    public IteracjaProsta(Uklad uk, double[] X_start) {
        n = uk.n;
        u = new Uklad(uk);
        X0 = new double[n];
    ...
    public void Iteruj(int iteracje, int norma, int wyswietlaj) {
        ...
        norma_x.add(NormaWektora(norma, x_st));
    ...
    //parametr norma jest opisany ponizej
    ...
    //Metoda wyznaczajaca norme wierszowa macierzy D, przyjmuje parametr norma:
